              ...
              <div className="px-6 sm:px-8 py-6 overflow-y-auto max-h-[calc(90vh-80px)] sm:max-h-[calc(85vh-100px)] text-right">
                <div className="prose prose-slate max-w-none text-[#0d141b] space-y-6">
                  ...
                  <section>
                    ...
                    <p className="text-sm leading-relaxed text-slate-700">
                      אנו מחויבים להנגשת האתר והשירותים הדיגיטליים שלנו לאנשים עם מוגבלויות, בהתאם לחוק שוויון זכויות לאנשים עם מוגבלות, התשנ&ldquo;ח–1998, ולתקנות שוויון זכויות לאנשים עם מוגבלות (התאמות נגישות לשירות), התשע&ldquo;ג–2013.
                    </p>
                    <div className="mr-4 mt-2 space-y-2">
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm leading-relaxed text-slate-700">
                          האתר עומד בדרישות תקן הנגישות הישראלי (ת&ldquo;י 5568) ובהנחיות WCAG 2.0 ברמה AA.
                        </p>
                      </div>
                      <div>
