        ...
        <div className="px-4 py-12 sm:px-8 md:px-16 lg:px-24 xl:px-40 flex flex-1 justify-center items-center">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Image/Visual Side */}
              <div className="relative bg-[#0d141b] p-12 flex flex-col justify-center items-center text-center text-white overflow-hidden">
                ...
                <div className="relative z-10">
                  <motion.div 
                    ...
                    className="w-24 h-24 bg-[#E7FE55] rounded-3xl flex items-center justify-center mb-8 mx-auto rotate-12"
                  >
                    <span className="material-symbols-outlined text-[#0d141b] text-5xl">auto_graph</span>
                  </motion.div>
                  <h2 className="text-3xl font-black mb-4">העתיד שלך מתחיל בחישוב אחד</h2>
                ...
                <div className="space-y-8">
                  ...
                  <div className="pt-6 space-y-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-[#E7FE55] hover:bg-[#d9f030] text-[#0d141b] font-black py-5 rounded-2xl shadow-xl shadow-[#E7FE55]/20 transition-all flex items-center justify-center gap-3 text-lg group"
                    >
